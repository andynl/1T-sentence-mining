...
#         "lemmaHash": ""
#     }
    # translate_search = requests.get("https://cache-asia.dioco.io/base_dict_getFullDict_3", params=params).json()

    # print(translate_search["data"]["rawDictData"]["d_lemma"]["dict"])

    # if definition_search[0]["meanings"]:
    #     for meaning in definition_search[0]["meanings"]:
    #         for definition in meaning["definitions"]:
                ...
                # " -> " 
                # + translate_search["data"]["rawDictData"]["d_lemma"]["trans"]["dict"])       
